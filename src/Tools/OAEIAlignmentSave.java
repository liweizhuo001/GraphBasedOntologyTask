...
public class OAEIAlignmentSave {
	 ...
	 * @throws Exception 
	 */
	public OAEIAlignmentSave(String pathname,String o1, String o2) throws Exception
	{	
		setOutput(pathname);	
		printHeader(o1, o2);	
	}
...
/*	public void addMapping2Output(String iri_str1, String iri_str2,String in_str3) throws Exception
	...
	public void addMapping2Output(String iri_str1, String iri_str2,String relation,String in_str3) throws Exception
	{
		...
		fw.write("\t\t\t<relation>"+relation+"</relation>\n");
