 ...
 * 1. 提供 MIPP 的计算函数
 * 2. 提供Mappings不一致修正函数
 * 最近修改时间：2017-10-10 ！important
 * @author Weizhuo Li
 **/

public class DiagnosisForMapping {
	String owlPath;
	String gPath;
	...
	public static DiagnosisForMapping getDiagnosis(GraphDatabaseService graphDB){
		return new DiagnosisForMapping(graphDB);
	}
	
	public static DiagnosisForMapping getDiagnosis(String owlPath,String gPath){
		return new DiagnosisForMapping(owlPath,gPath);
	}
	
	public DiagnosisForMapping(String owlPath,String gPath){
	...
	public DiagnosisForMapping(GraphDatabaseService graphDB){
